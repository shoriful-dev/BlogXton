...
const BannerCart = ({ imgSrc = '', btnText = '', bannerImage = '' }) => {
  return (
    <div
      className="w-[480px] h-[541px] rounded-md relative group overflow-hidden"
      style={{
    ...
    >
      ...
      <div className="w-full h-[210px] absolute bottom-[-50px] opacity-0 group-hover:opacity-100 group-hover:bottom-0 duration-500 group-hover:bg-white">
        <div className="w-[90%] mx-auto border mt-5 rounded-lg flex justify-between items-center px-3">
          ...
          <div className="flex items-center space-x-2">
            <h3 className="text-[15px] font-medium font-Inter">Nov 22, 2022</h3>
          </div>
          <span>
            <LuDot className="text-red text-xl" />
          </span>
